...
CFLAGS+=-I . -I $(PREFIX)/include -DWOLFSSL_PICOTCP -DTFM_TIMING_RESISTANT -DNO_WRITEV -DNO_ERROR_STRINGS -DSMALL_SESSION_CACHE -DWOLFSSL_SMALL_STACK -DHAVE_TLS_EXTENSIONS -DNO_DSA -DNO_RABBIT -DNO_MD4 -DNO_DES3 -DNO_FILESYSTEM -DUSE_FAST_MATH -DRSA_DECODE_EXTRA -DHAVE_ECC -DHAVE_ALL_CURVES -DHAVE_SUPPORTED_CURVES -DPICOTCP=1 -DSINGLE_THREADED -DWOLFSSL_USER_IO
